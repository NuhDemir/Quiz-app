// moved from tests/passwordReset.test.js
...
describe("Password Reset Flow", () => {
  test("happy path: request -> reset -> login with new password", async () => {
    ...
    const email = `resetuser_${uniqueSuffix}@example.com`;
    const username = `resetuser_${uniqueSuffix}`;
    ...
    const devResetToken = reqBody.devResetToken;
